...
class StanbicPaymentsInitiation(Document):
	...
	def on_update_after_submit(self):
		if self.stanbic_ack_change and self.stanbic_ack:
			...
			stanbic_ack_status = ack_dict["Document"]["CstmrPmtStsRpt"]["OrgnlGrpInfAndSts"]["GrpSts"]
			if ack_dict["Document"]["CstmrPmtStsRpt"]["OrgnlGrpInfAndSts"].get("StsRsnInf"):
				stanbic_ack_status = (
					stanbic_ack_status
					+ " "
					+ ack_dict["Document"]["CstmrPmtStsRpt"]["OrgnlGrpInfAndSts"]["StsRsnInf"]["AddtlInf"]
				)
		...
		if self.stanbic_intaud_change and self.stanbic_intaud:
			...
			TxInfAndSts = ack_dict["Document"]["CstmrPmtStsRpt"]["OrgnlPmtInfAndSts"]["TxInfAndSts"]
